...
//		}
		...
		if (result.getScore()<0.1 ||result.getScore()>0.9) {
			System.out.printf("move: %s score: %.6f, predict:%.6f, running diff: %.6f", result.getMove(), result.getScore(), predict);
